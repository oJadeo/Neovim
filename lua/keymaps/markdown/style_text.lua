-- Format all Markdown files in the current git repository
-- Useful for bulk formatting after changing formatter settings
-- To re-enable: Uncomment the vim.keymap.set block below
--
